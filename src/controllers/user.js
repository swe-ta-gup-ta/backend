...
const generateAccessAndRefreshTokens = async(userId) => {
    try {
        ...
        throw new ApiError(500, "Something went wrong while genarting refresh and access tokens")
    }
}

const registerUser = asyncHandler( async (req, res) => {
    // get user detail from frontend
    // check varlidation - not empty
...
const loginUser = asyncHandler( async (req, res) => {
    ...
    if (!user) {
        throw new ApiError(404, "User does notr exists")
    }
...
const updateUserAvatar = asyncHandler(async(erq, es) => {
...
const updateUserCoverImage = asyncHandler(async(erq, es) => {
